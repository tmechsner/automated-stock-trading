...
class ConstantPredictor(AbstractPredictor):
    ...
    def predict(self, X, y, todays_features, training_years, trading_days_per_year) -> pd.Series:
        return y[-1]  # Suggest that the trend of the last trading period repeats itself
